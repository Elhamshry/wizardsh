...
<nav class="page-controls navbar navbar-dashboard">
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header mr-md-3">
            ...
            <!-- xs & sm screen logo -->
            <a class="navbar-brand d-md-none" href="{{ asset('dashboard/index.html') }}">
                                ...
                                <div class="btn-group btn-group-sm btn-group-toggle" id="notifications-toggle" data-toggle="buttons">
                                    <label class="btn btn-default active">
                                        ...
                                        <input type="radio" checked
                                               ...
                                               data-ajax-load="{{ route('demo/ajax/notifications.html') }}"
                                               data-ajax-target="#notifications-list"> Notifications
                                    </label>
                                    <label class="btn btn-default">
                                        <input type="radio"
                                               data-ajax-trigger="change"
                                               data-ajax-load="{{ route('demo/ajax/messages.html') }}"
                                               data-ajax-target="#notifications-list"> Messages
                                    </label>
                                    <label class="btn btn-default">
                                        <input type="radio"
                                               data-ajax-trigger="change"
                                               data-ajax-load="{{ route('demo/ajax/progress.html') }}"
...
<div class="content-wrap">
    ...
    <main id="content" class="content" role="main">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="{{ asset('img/3727714.jpg" alt="First slide') }}">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{ asset('img/3808949.jpg" alt="Second slide') }}">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{ asset('img/3993931.jpg" alt="Third slide') }}">
                                    </div>
                                </div>
                ...
                <aside class="fixed-aside">
                    ...
                    <div class="pb-xlg">
                        <section class="widget joined  h-100">
                            <div class="widget-body">
                                <div class="ads">
                                    <img class="" src="{{ asset('img/images.jpg') }}">
                                </div>
                            </div>
                        </section>
                    </div>
                    ...
                    <section class="widget">
                        ...
                        <div class="widget-body">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-6 mb-5">
                                    <a href="mobile_app.html" class="link-course">
                                        <div class="card card-block">
                                ...
                                <div class="col-md-3 col-sm-6 mb-5">
                                    <a href="cyber_security.html" class="link-course">
                                        <div class="card card-block">
                                ...
                                <div class="col-md-3 col-sm-6 mb-5">
                                    <a href="data_base.html" class="link-course">
                                        <div class="card card-block">
                    ...
                    <section class="widget">
                        ...
                        <div class="widget-body">
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <button class="material-btn" data-toggle="modal" data-target="#elegantModalForm"> &#43; <a href="/addcmaterial/create"  >Add Material</a> </button>
                                </div>
                            </div>
                        </div>
                    </section>
        ...
        <!-- Modal -->
        <div class="modal fade" id="elegantModalForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel class={{route(co)}}"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content form-elegant">
                    ...
                    <!--Body-->
                    <div class="container">
                    <form method = "post" action = "{{route('addcmaterial.store ')}}" >
                    <div class="modal-body mx-4"   >
                        <!--Body-->

                        <div class="md-form mb-5" >
                            <label data-error="wrong" data-success="right" for="Form-email1">Course Name</label>
                            <input type="text"  name="name" class="form-control validate" placeholder="Angular - The Complete Guide (2020 Edition)/">
                        </div>
                        <div class="md-form mb-5">
                            <label data-error="wrong" data-success="right" for="Form-email1">Add Link</label>
                            <input type="url" name="link" class="form-control validate" placeholder="https://www.udemy.com/courses/development/">
                        </div>
                        <div class="md-form mb-5">
                            <label data-error="wrong" data-success="right" for="Form-email1">Add Image</label>
                            <input type="file"  name="image" accept="image/*" style="height: auto" class="form-control validate">
                        </div>
                        <div class="md-form mb-5">
                            <label data-error="wrong" data-success="right" for="Form-email1">Add Discription</label>
                            <textarea type="text" name="description" class="form-control validate" placeholder="This course starts from scratch, you neither need to know Angular 1 nor Angular 2!">
                            </textarea>
                        </div>
...
<script>
    import "{{ asset('node_modules/jquery/dist/jquery.min.js') }}";
</script>
...
<script src="{{ asset('node_modules/pace.js/pace.js" data-pace-options='{ "target": ".content-wrap", "ghostTime": 1000 }') }}"></script>
...
<!-- Page scripts -->
<script src="{{ asset('node_module/s/flot.animator/jquery.flot.animator.min.js') }}"></script>
...
<script src="{{ asset('node_modules/jquery-sparkline/jquery.sparkline.j') }}s"></script>
<script src="{{ asset('node_modules/bootstrap_calendar/bootstrap_calendar/js/bootstrap_calendar.min.js') }}"></script>
...
<script id="AnyMod-script">
    ...
    })("AnyMod","library","https://cdn.anymod.com/v2",window,document,"script",{ toolkit: false, tips: true, priority: 3 });
</script>
